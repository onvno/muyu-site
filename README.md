# GitHub Pages 支持页与隐私页

这是「禅:静心一击」首发所需的静态支持页。建议创建一个**独立公开仓库** `muyu-site`，不要为了发布此页面而公开应用源码。

## 发布步骤

1. 在 GitHub 创建公开仓库：`muyu-site`。
2. 将本目录的 `index.html` 和 `privacy.html` 上传到新仓库根目录。
